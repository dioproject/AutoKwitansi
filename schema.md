...
| kena_pph21_5 | INTEGER | 0 | **[v3.7]** 1 = narasumber kena PPh 21 5% (manual, eksklusif) |
...
**Catatan pajak (kena_pph21/21_5/23/23_2=1, plus ppn_nominal opsional):**
- `jumlah` tetap menyimpan **bruto**.
- PPh 21 = 6% × bruto; PPh 21 5% = 5% × bruto; PPh 23 = 4% × bruto; PPh 23 2% = 2% × bruto; PPN = nominal input; total = bruto − PPh − PPN (dihitung saat render/print, tidak disimpan).
